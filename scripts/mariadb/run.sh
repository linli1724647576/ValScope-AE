...
LOG_FILE="${LOG_DIR}/mariadb_${MUTATOR_TYPE}_${TIMESTAMP}.txt"
...
# Strict version from documents/DBMS Version.md: MariaDB 12.0.2-MariaDB-ubu2404
IMAGE="mariadb:12.0.2"
CONTAINER="valscope-mariadb-12-0-2"
PREFERRED_PORT=9901
